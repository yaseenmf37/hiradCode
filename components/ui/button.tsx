...
const variants: Record<Variant, string> = {
  primary:
    "from-neon-pink to-neon-violet text-white bg-gradient-to-l shadow-[0_10px_40px_-8px_rgb(255_46_139/0.6)] hover:shadow-[0_14px_50px_-6px_rgb(255_46_139/0.8)] hover:brightness-110 active:scale-[0.98]",
  outline:
